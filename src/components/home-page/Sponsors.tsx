...
type TiersType = 'Etios / Sedan' | 'Kia Carens' | 'Ertiga' | 'Innova Crysta';

const tiers: TiersType[] = ['Etios / Sedan', 'Kia Carens', 'Ertiga', 'Innova Crysta'];
...
const HomeSponsors: React.FC<Props> = ({ title, sponsors, bcmsConfig }) => {
    const [activeTier, setActiveTier] = useState<TiersType>('Kia Carens');
        ...
        <section className="pb-16 lg:pb-[176px]">
            <div className="container">
                <div className="flex items-center justify-between mb-6 lg:mb-16">
                    <h2 className="leading-none tracking-[-0.02em] font-semibold lg:text-5xl lg:leading-none">
                        {title}
                    </h2>
                    <div
                        ...
                        {filteredSponsors.length &&
                            filteredSponsors.map((sponsor, index) => (
                                <SwiperSlide key={index}>
                                    <div className="w-[295px] aspect-[2.17] rounded-lg bg-white mx-auto mb-6 lg:w-[462px] lg:aspect-[1.7] lg:rounded-2xl lg:mb-12 overflow-hidden">
                                        <BCMSImage
                ...
                <button
                    ...
                    onClick={() => window.location.href = "mailto:onewaycabbie@gmail.com"}
                >
                    Mail us
                </button>
            </div>
